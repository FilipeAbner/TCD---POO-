 ...
 * @author Natã
 */
public class CadastrarIdioma extends javax.swing.JPanel {

    public CadastrarIdioma() {
    ...
    private void pnlbtnCadastrarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_pnlbtnCadastrarMouseClicked
        ...
        idioma.setIdioma(txtNome.getText());
        
        new IdiomaDao().salvar(idioma);
