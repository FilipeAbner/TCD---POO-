 ...
 * @author Natã
 */
public class ExcluirIdioma extends javax.swing.JPanel {

    
    private Idioma idiomaAtributo;
    
    public ExcluirIdioma() {
    ...
    public void carregarInformacoes() {
        ...
        if(idioma == null){
            ...
            JOptionPane.showMessageDialog(
                null, "Idioma não encontrado.");
            
            return;
           
        }
        
        txtNome.setText(idioma.getIdioma());
        
        idiomaAtributo = idioma;
    }
    ...
    private void pnlbtnCadastrar1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_pnlbtnCadastrar1MouseClicked
        ...
        if(txtID.getText().isEmpty()){
            ...
            JOptionPane.showMessageDialog(
                null, "Localize o Idioma.");
            
        }
        
        Livro livroLocalizado =
            new LivroDao().localizarLivrosPorIdioma(idiomaAtributo.getId());
        
        if(livroLocalizado != null){
            
            JOptionPane.showMessageDialog(
                null, "Não é possível excluir um idioma que possui "
        ...
        new IdiomaDao().deletarDeFato(idiomaAtributo);

        JOptionPane.showMessageDialog(
            null, "Idioma exluido com sucesso.");
