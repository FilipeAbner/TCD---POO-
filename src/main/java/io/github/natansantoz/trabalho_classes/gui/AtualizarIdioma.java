 ...
 * @author Natã
 */
public class AtualizarIdioma extends javax.swing.JPanel {

    private Idioma idiomaAtributo;
    
    public AtualizarIdioma() {
    ...
    private void pnlbtnCadastrar1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_pnlbtnCadastrar1MouseClicked
        ...
        idiomaAtributo.setIdioma(txtNome.getText());
        
        new IdiomaDao().salvar(idiomaAtributo);
        
        JOptionPane.showMessageDialog(
            null, "Idioma atualizado com sucesso.");
